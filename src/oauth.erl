...
get(URL, ExtraParams, Consumer, Token, TokenSecret, HttpcOptions, ExtraHeaders) ->
  SignedParams = sign("GET", URL, ExtraParams, Consumer, Token, TokenSecret),
  http_request(get, {uri(URL, SignedParams), ExtraHeaders}, HttpcOptions).
...
post(URL, ExtraParams, Consumer, Token, TokenSecret, HttpcOptions, ExtraHeaders) ->
  SignedParams = sign("POST", URL, ExtraParams, Consumer, Token, TokenSecret),
  http_request(post, {URL, ExtraHeaders, "application/x-www-form-urlencoded", uri_params_encode(SignedParams)}, HttpcOptions).
...
put(URL, ExtraParams, {ContentType, Body}, Consumer, Token, TokenSecret, HttpcOptions, ExtraHeaders) ->
  SignedParams = sign("PUT", URL, ExtraParams, Consumer, Token, TokenSecret),
  http_request(put, {uri(URL, SignedParams), ExtraHeaders, ContentType, Body}, HttpcOptions).
